...
! ***********************************************************************
      ...
      subroutine data_for_extra_history_columns(id, n, names, vals, ierr)
         ...
         real(dp) :: c12_c13, c12_c13_TP1, n14_n15, n14_n15_TP1, c_o, c_o_TP1
         integer, intent(out) :: ierr
         integer :: k
         type (star_info), pointer :: s
         ierr = 0
...
! check we've finished core He burning first:

         if (s% center_he4 .lt. 0.000001) then  
       
! if not currently in a thermal pulse but the He burning luminosity has surpassed this threshold, then we are *now* in a thermal pulse. 
! Add pulse to the total count:
